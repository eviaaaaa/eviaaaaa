...
6. [fix(console): resolve table checkbox overlapping issue in sessions page](https://github.com/agentscope-ai/CoPaw/pull/936) in [agentscope-ai/CoPaw](https://github.com/agentscope-ai/CoPaw)
